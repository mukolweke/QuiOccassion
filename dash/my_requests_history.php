...
<div>
    ...
    <div class="table-wrapper">
        <div class="table-header">
            <p class="table-subtitle">List of My Requests History</p>
        </div>
        ...
        <div class="table-list">
            ...
            <?php
            $sql = "SELECT user_requests.*, users.full_name as user_name FROM user_requests INNER JOIN users ON user_requests.user_id=users.id AND user_requests.status=1 AND user_requests.user_id=".$_SESSION['id']." ORDER BY user_requests.id DESC";
            $count = 1;
            $date_now = date("d/m/Y");
