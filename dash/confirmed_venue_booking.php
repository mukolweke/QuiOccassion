...
<div>
    ...
    <div class="table-wrapper">
        <div class="table-header">
            <p class="table-subtitle">List of Confirmed Booked Venues</p>
        </div>
        
        <div class="table-list">

            <?php
            $sql = "SELECT user_booking.*, venues.name as venue_name, venues.address as venue_address, venues.rate as venue_rate FROM user_booking INNER JOIN venues ON user_booking.venue_id=venues.id AND user_booking.status=1 ORDER BY user_booking.id DESC";
