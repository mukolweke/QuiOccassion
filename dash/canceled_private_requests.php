...
<div>
    ...
    <div class="table-wrapper">
        <div class="table-header">
            <p class="table-subtitle">List of Cancelled Private Requests</p>
        </div>
        
        <div class="table-list">

            <?php
            $sql = "SELECT user_requests.*, users.full_name as full_name, users.email as email FROM user_requests INNER JOIN users ON user_requests.user_id=users.id AND user_requests.status=2 ORDER BY user_requests.id DESC";
